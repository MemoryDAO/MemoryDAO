...
const config = {
  title: 'Memory DAO',
  tagline: 'Memory DAO',
  url: 'https://movie-dao-smoky.vercel.app/',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/favicon.ico',
  organizationName: 'Memory DAO', // Usually your GitHub org/user name.
  projectName: 'Memory DAO', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/MemoryDAO/MemoryDAO.git',
        ...
        blog: {
          ...
          // Please change this to your repo.
          editUrl:
            'https://github.com/MemoryDAO/MemoryDAO.git',
        },
        theme: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'GitHub',
                href: 'https://github.com/MemoryDAO/MemoryDAO.git',
              },
            ],
          },
        ],
        copyright: `Copyright © ${new Date().getFullYear()} Memory DAO`,
      },
      prism: {
